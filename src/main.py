...
from prix_instantane_carburant import telecharger_donnes_economie_gouv
from consommation_brute_quaotidienne_gaz_elec import telecharger_data_gouv
...
for config in configuration:
    if config["type_api"] == "economie_gouv":
        resultat = telecharger_donnes_economie_gouv(config["dataset"])
